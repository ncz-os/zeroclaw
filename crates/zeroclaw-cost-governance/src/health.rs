...
//! Closed -> degraded -> open (down) with consecutive-failure counting and a
//! half-open cooldown probe so models can recover automatically.
//!
//! This is a routing capability signal — "is this free model worth selecting
//! right now?" — not a duplicate of any provider-internal reliability state.
